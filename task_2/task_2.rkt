...
(list 'ofir 'ovadia (cons 'age (append (list 25 'x) (cons 25 null))) :
                   ...
                   (list <LE> <LE> <LE>) (4)
          <sym> (2) <sym> (2)     (cons <LE> <LsE>)
                              <sym> (2)  (append <LsE> <LsE>) (9)
                                     (list <LE> <LE>)(7)  (cons <LE> <LsE>) (8)
                                   <num> (1) <sym> (2)     <num> (1)   (list <LE>) (7)
                                                                              <null> (3)
|#
...
( : Bintree-square : Number -> BINTREE)
  (define (Bintree-square num)
...
(test (tree-map Bintree-square (Node (Leaf 1) (Node (Leaf 2) (Leaf 3))))=> (Node (Leaf 1) (Node (Leaf 4) (Leaf 9))))
(test (tree-map Bintree-square (Node (Leaf 9) (Node (Leaf 10) (Leaf 11))))=> (Node (Leaf 81) (Node (Leaf 100) (Leaf 121))))
(test (tree-map Bintree-square (Node (Leaf 5) (Node (Leaf 4) (Leaf -2))))=> (Node (Leaf 25) (Node (Leaf 16) (Leaf 4))))